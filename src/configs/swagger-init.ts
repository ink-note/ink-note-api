...
export function SwaggerInitializer(path: string, app: NestExpressApplication): void {
  const config = new DocumentBuilder().setTitle('Ink Note API').setVersion('1.0').addBearerAuth().build();
